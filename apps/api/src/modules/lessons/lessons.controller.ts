...
export class LessonsController {
  ...
  reorder(@Body() body: { courseId: string; lessonIds: string[] }, @CurrentUser() user: any) {
  ...
  trackProgress(@Param('id') id: string, @Body() progressDto: any, @CurrentUser() user: any) {
  ...
  addQuiz(@Param('id') id: string, @Body() quizDto: any, @CurrentUser() user: any) {
